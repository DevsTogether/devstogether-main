    ...
    return (
        <>
            <div className="container">
                ...
                <p>
                    A sua privacidade é importante para nós. É política do Devs
                    Together respeitar a sua privacidade em relação a qualquer
                    informação sua que possamos coletar no site{' '}
                    <a href="https://devstogether.vercel.app/">Devs Together</a>
                ...
                <p>
                    ...
                    <a>Aviso de Privacidad</a>e informações pessoais. Se você
                    tiver alguma dúvida sobre como lidamos com dados do usuário
                    e informações pessoais, entre em contacto connosco.
                </p>
                <p></p>
                <h2>Política de Cookies Devs Together</h2>
                ...
                <p>
                    ...
                    descreve quais informações eles coletam, como as usamos e
                    por que às vezes precisamos armazenar esses cookies. Também
                    compartilharemos como você pode impedir que esses cookies
                    sejam armazenados, no entanto, isso pode fazer o downgrade
                    ou &quot;quebrar&quot; certos elementos da funcionalidade do
                    site.
                </p>
                ...
                <p>
                    ...
                    adicionam a este site. É recomendável que você deixe todos
                ...
                <p>
                    ...
                    navegador para saber como fazer isso). Esteja ciente de que
                    a desativação de cookies afetará a funcionalidade deste e de
                    muitos outros sites que você visita. A desativação de
                    cookies geralmente resultará na desativação de determinadas
                ...
                <ul>
                    <li>
                        ...
                        <br />
                        <br />
                        Se você criar uma conta connosco, usaremos cookies para
                        o gerenciamento do processo de inscrição e administração
                        geral. Esses cookies geralmente serão excluídos quando
                        você sair do sistema, porém, em alguns casos, eles
                        poderão permanecer posteriormente para lembrar as
                    ...
                    <li>
                        ...
                        efetua logout para garantir que você possa acessar
                    ...
                    <li>
                        ...
                        úteis ou para entender nossa base de usuários com mais
                        precisão. Essas pesquisas podem usar cookies para
                        lembrar quem já participou numa pesquisa ou para
                        fornecer resultados precisos após a alteração das
                        páginas.
                        <br />
                        <br />
                    </li>
                    <li>
                        ...
                        os encontrados nas páginas de contacto ou nos
                ...
                <ul>
                    <li>
                        ...
                        produzindo conteúdo atrativo. Esses cookies podem
                        rastrear itens como o tempo que você passa no site ou as
                        páginas visitadas, o que nos ajuda a entender como
                    ...
                    <li>
                        ...
                        realmente compram e, portanto, esse é o tipo de dados
                        que esses cookies rastrearão. Isso é importante para
                        você, pois significa que podemos fazer previsões de
                        negócios com precisão que nos permitem analizar nossos
                        custos de publicidade e produtos para garantir o melhor
                        preço possível.
                    </li>
                </ul>
                <p />
                ...
                <p>
                    ...
                    da informação que o Devs Together oferece no site e com
                ...
                <ul>
                    ...
                    <li>
                        ...
                        racista, xenofóbica, <a>apostas online</a>
                    ...
                    <li>
                        ...
                        lógicos (softwares) do Devs Together, de seus
                ...
                <p>
                    ...
                    <strong>31 julho 2022 20:19</strong>
                </p>
            </div>
            <style jsx>{`
                .container {
