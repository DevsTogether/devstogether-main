        ...
        <Perguntas>
          ...
          <div className='perguntas1'>
            <div>
              ...
              <h4>O que faz o display flex no CSS</h4><br />
              <Chip icon={<EmojiEventsIcon />} label="With Icon" />
            </div>
        ...
        <Desafios>
          ...
          <div className="separador">
            ...
            <div className="progress" align="center">
              <Slider sx={{ width: 100, top: '50%', mr: 5 }} defaultValue={50} aria-label="Default" valueLabelDisplay="auto" />
            </div>
          </div>
          <hr />
